...
:::tip[La promesse]
Une commande, `bun create lisible`, puis un site rapide, accessible, indexable et prêt à être personnalisé.
:::
...
- des garde-fous qualité : contrôles de liens et d’assets, tests unitaires et de bout en bout, conformité inter-variantes.
...
5. Activez ou désactivez les capacités dans `lisible.config.json`.
