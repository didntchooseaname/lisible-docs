...
Les fichiers de `shared/` restent sans dépendance runtime autre que celles installées à la racine du dépôt : `shared/` n’a pas de `node_modules`, la résolution remonte donc jusqu’à la racine.
