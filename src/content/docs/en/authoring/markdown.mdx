...
A `mermaid` fence becomes an interactive diagram. Its toolbar provides zoom, pan, reset and source copy controls; colors synchronize with the light or dark theme. The content itself follows Mermaid syntax.
