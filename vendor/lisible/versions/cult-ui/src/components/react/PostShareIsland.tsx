import { Check, Copy, ExternalLink, FileText, Link as LinkIcon, Sparkles } from "lucide-react";
...
export function PostShareIsland({
  ...
  const aiPrompt = markdownUrl ? `${title}\n${markdownUrl}` : `${title}\n${url}`;
  ...
  return (
    <div className="mt-12 flex flex-wrap items-center justify-between gap-4 border-t border-border pt-6">
      {showShare ? (
        // biome-ignore lint/a11y/useSemanticElements: a fieldset would drag form styling into a plain share row
        <div
