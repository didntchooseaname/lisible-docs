...
export function CodeBlock({
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: recheck overflow on content changes
  useLayoutEffect(() => {
    const checkOverflow = () => {
      if (preRef.current) {
  ...
  return (
    <div
      className={cn(
        ...
        "border-neutral-950/10 dark:border-white/10",
          ...
          >
            <div ref={tabsContainerRef} className="relative flex gap-1">
              {codeContent.map((tab, index) => (
                <button
                  ...
                  className={cn(
                    ...
                    "px-1.5 rounded-lg",
                    "first:ml-2.5",
                    "hover:bg-neutral-200/50 dark:hover:bg-neutral-700/70",
                    activeTab === index
                      ? "text-neutral-950 dark:text-neutral-50"
              ...
              {indicator && (
                <motion.div
                  aria-hidden="true"
                  className="pointer-events-none absolute bottom-0 h-0.5 rounded-full bg-neutral-950 dark:bg-neutral-50"
                  initial={false}
                  animate={{
                    left: indicator.left,
      ...
      <div className="relative overflow-hidden">
        ...
        <motion.button
          ...
          className={cn(
            ...
            "flex min-h-11 items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-lg",
            "text-neutral-500 dark:text-neutral-400",
        ...
        <pre
          ...
          className={cn(
            ...
            "bg-white dark:bg-neutral-950/50",
        ...
        >
          <AnimatePresence mode="wait" initial={false} custom={direction}>
            <motion.code
              ...
              className="font-mono text-neutral-950 dark:text-neutral-50 block whitespace-pre"
            >
              {currentCode}
            </motion.code>
          </AnimatePresence>
