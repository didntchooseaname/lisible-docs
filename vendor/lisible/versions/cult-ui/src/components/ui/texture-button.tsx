...
const buttonVariantsOuter = cva("", {
  variants: {
    variant: {
      ...
      accent:
        "w-full border-[1px] dark:border-[2px] border-black/10 dark:border-neutral-950 bg-gradient-to-b from-accent/60 to-accent dark:from-accent/50 dark:to-accent p-[1px] transition duration-300 ease-in-out ",
      destructive:
...
const innerDivVariants = cva(
  "w-full h-full flex items-center justify-center text-muted-foreground",
  {
    variants: {
      variant: {
        primary:
          "gap-2 bg-gradient-to-b from-neutral-800 to-black  dark:from-neutral-200 dark:to-neutral-50 text-sm text-white/90 dark:text-black/80 transition duration-300 ease-in-out  hover:from-neutral-800 hover:to-neutral-800/70 dark:hover:from-neutral-200 dark:hover:to-neutral-200 dark:active:from-neutral-300 dark:active:to-neutral-300 active:bg-gradient-to-b active:from-black active:to-black ",
        accent:
          "gap-2 bg-gradient-to-b from-accent/80 to-accent text-sm text-accent-foreground transition duration-300 ease-in-out hover:bg-gradient-to-b hover:from-accent/60 hover:to-accent/80 dark:hover:from-accent/60 dark:hover:to-accent/80 active:bg-gradient-to-b active:from-accent/70 active:to-accent/90 dark:active:from-accent dark:active:to-accent",
        destructive:
