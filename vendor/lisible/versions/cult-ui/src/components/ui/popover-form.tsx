  ...
  return (
    ...
    >
      <motion.button
        ...
        className="flex min-h-11 items-center border bg-white dark:bg-card px-4 text-sm font-medium outline-none"
      >
            ...
            <AnimatePresence mode="popLayout">
              {showSuccess ? (
                ...
                <motion.div
                  ...
                  className="h-full border bg-white dark:bg-card z-20 "
                >
                  {openChild}
                </motion.div>
              )}
...
export function PopoverFormButton({
  ...
  return (
    <button
      type="submit"
      className="ml-auto flex min-h-11 w-26 items-center justify-center overflow-hidden rounded-md bg-gradient-to-b from-primary/90 to-primary px-3 text-xs font-semibold text-primary-foreground shadow-[0_0_1px_1px_rgba(255,255,255,0.08)_inset,0_1px_1.5px_0_rgba(0,0,0,0.32),0_0_0_0.5px_var(--color-accent)]"
    >
