...
export const LogoLoop = React.memo<LogoLoopProps>(
  ({
        ...
        if (renderItem) {
          return (
            <li
              ...
              key={key}
              // biome-ignore lint/a11y/noRedundantRoles: Safari drops list semantics on style-reset lists without the explicit role
              role="listitem"
            >
              {renderItem(item, key)}
            </li>
    ...
    return (
      // biome-ignore lint/a11y/useSemanticElements: keeping the div avoids retagging a kit component, region semantics come from the role
      <div
        ref={containerRef}
      ...
      >
        ...
        {/* biome-ignore lint/a11y/noStaticElementInteractions: hover handlers only pause the marquee animation */}
        <div
          className={cx(
