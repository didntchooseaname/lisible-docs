      ...
      <body>
        <div class="wrap">
          <div class="banner">
            ...
            <p>An RSS feed lets you follow this blog in a dedicated reader. Copy this page's address into your reader (<code>Feedly</code>, <code>NetNewsWire</code>, <code>Thunderbird</code>...) to get new posts automatically.</p>
          </div>
          <span class="accent"></span>
          <h1><xsl:value-of select="/rss/channel/title"/></h1>
          <p class="lead"><xsl:value-of select="/rss/channel/description"/></p>
          <a class="home" href="{/rss/channel/link}">Visit the site &#8594;</a>
