    ...
    <html lang="fr">
      ...
      <body>
        <div class="wrap">
          ...
          <div class="note">
            <p style="margin:0 0 .5rem"><strong>Qu'est-ce qu'un flux RSS ?</strong></p>
            <p style="margin:0">Un flux RSS vous permet de suivre les nouveaux articles sans dépendre d'un réseau social ni d'une newsletter. Copiez l'URL de cette page dans un lecteur de flux (par exemple <code>NetNewsWire</code>, <code>Feedly</code> ou <code>Thunderbird</code>) pour être averti à chaque publication.</p>
          </div>
          ...
          <a class="home" href="{/rss/channel/link}">Retour au site</a>
        </div>
      </body>
    </html>
  </xsl:template>
