...
>) {
  ...
  const highlight =
    "radial-gradient(75% 181.2% at 50% 50%, var(--color-accent) 0%, transparent 100%)";
  ...
  return (
    <Tag
      ...
      className={cn(
        "relative flex h-min w-fit flex-col flex-nowrap content-center items-center justify-center gap-10 overflow-visible rounded-full border border-border bg-secondary/40 p-px decoration-clone transition duration-500 hover:bg-secondary/20",
        containerClassName,
      )}
      {...props}
    >
