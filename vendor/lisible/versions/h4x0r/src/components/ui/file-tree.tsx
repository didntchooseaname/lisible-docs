...
>(({ className, elements, expandAll = false, label, children, ...props }, ref) => {
  ...
  return (
    <button
      type="button"
      className={cn(
        "hover:bg-secondary absolute right-2 bottom-1 inline-flex h-8 w-fit items-center justify-center rounded-md p-1 transition-colors",
        className
      )}
      onClick={
