...
const fr = {
  ...
  cyber: {
    ...
    certifications: {
      scanCmd: "ls /coffre/accreditations --verifie",
      ...
      authority: "AUTORITÉ",
      report: "Consulter le rapport lié",
      reportsLabel: "rapports liés",
      reportsTitle: "Journaux d'accréditation",
    },
    friends: {
      scanCmd: "cat /etc/lisible/operateurs.roster",
      roster: "Réseau :: opérateurs",
      description: "Réseau d'opérateurs fictif pour la démonstration de Lisible.",
      intro: "Tous les noms, portraits et profils de ce réseau sont fictifs.",
      count: (n: number) => (n === 1 ? "1 opérateur recensé" : `${n} opérateurs recensés`),
      node: "NŒUD",
      linkActive: "LIAISON ACTIVE",
      channel: "Canal externe",
    },
    about: {
...
const en: Dict = {
  ...
  cyber: {
    ...
    certifications: {
      scanCmd: "ls /vault/clearances --verify",
      registry: "Registry :: clearances",
      description: "Fictional certifications presented as operator clearances.",
      intro: "Every badge, organization and learning path on this page is entirely fictional.",
      count: (n: number) => (n === 1 ? "1 verified clearance" : `${n} verified clearances`),
      clearance: "CLEARANCE",
      issued: "ISSUED",
      verified: "INTEGRITY OK",
      authority: "AUTHORITY",
      report: "Open the linked report",
      reportsLabel: "linked reports",
      reportsTitle: "Clearance logs",
    },
    friends: {
      scanCmd: "cat /etc/lisible/operators.roster",
      roster: "Network :: operators",
      description: "A fictional operator network for the Lisible demo.",
      intro: "Every name, portrait and profile on this network is fictional.",
      count: (n: number) => (n === 1 ? "1 operator on file" : `${n} operators on file`),
      node: "NODE",
