  ...
  <xsl:template match="/">
    <html lang="fr">
      ...
      <body>
        <div class="wrap">
          <div class="banner">
            <strong>Ceci est un flux RSS.</strong> Copiez l'adresse de cette page
            dans votre lecteur de flux (Feedly, NetNewsWire, Thunderbird...) pour
            recevoir les nouveaux articles automatiquement, sans compte ni algorithme.
          </div>
